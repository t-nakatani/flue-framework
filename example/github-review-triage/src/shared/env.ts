export type AppEnv = {
  ...
  FLUE_REPO_IMPLEMENTATION_MODEL?: string;
  GITHUB_TOKEN?: string;
  GITHUB_WEBHOOK_SECRET?: string;
  GITHUB_WRITE_MODE?: string;
  TRIAGE_LABELS?: string;
  IMPLEMENTATION_REPO_OWNER?: string;
  IMPLEMENTATION_REPO_NAME?: string;
  IMPLEMENTATION_BASE_BRANCH?: string;
  IMPLEMENTATION_BRANCH_PREFIX?: string;
  IMPLEMENTATION_TRIGGER_LABEL?: string;
  IMPLEMENTATION_MAX_FILE_WRITES?: string;
  IMPLEMENTATION_MAX_FILE_CHARS?: string;
